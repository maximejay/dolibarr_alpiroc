 ...
 *  \file       htdocs/mymodule/core/modules/modAlpiroc.class.php
 *  \ingroup    mymodule
 ...
 */
class modAlpiroc extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		// Example: this->dirs = array("/mymodule/temp");"/alpiroc/core/modules/propale/tmp"
		$this->dirs = array();

		// Config pages. Put here list of php page, stored into mymodule/admin directory, to use to setup module.
		$this->config_page_url = array("alpiroc_setupapage.php@alpiroc");
		...
		$this->langfiles = array("alpiroc@alpiroc");
	...
	{
		//$sql = array();
		//~ mkdir("/home/maxime/web/dolibarr-3.6.0/htdocs/alpiroc/core/modules/propale/tmp");
		$result=$this->_load_tables('/alpiroc/sql/');
		$sql = array('INSERT INTO '.MAIN_DB_PREFIX.'document_model (nom ,entity ,type) VALUES (\'alpiroc\', \'1\', \'propal\');',
		'INSERT INTO '.MAIN_DB_PREFIX.'document_model (nom ,entity ,type) VALUES (\'alpiroc_fact\', \'1\', \'invoice\');',
		'INSERT INTO '.MAIN_DB_PREFIX.'document_model (nom ,entity ,type) VALUES (\'alpiroc_com\', \'1\', \'order\');'
		);
		
		//TODO : Proper way to insert extrafield : we need to construc an array with options key and serialize it
		//~ $myarray=array("options"=>array("alpiroc:profil:profil:: GROUP BY profil"=>NULL));//Array to construct for extrafield sellist chosing alipiroc profil
		//~ $myarray=array("options"=>array(""=>NULL));//Array to construct for extrafield titre alpiroc
		//~ $myarray_serialize=serialize($myarray);
		//~ $sql = array('INSERT INTO llx_extrafields (name,entity,elementtype,tms,label,type,size,fieldunique,fieldrequired,pos,param) VALUES (\'titrealpiroc\',\'1\',\'propaldet\',\'\',\'Insérer un titre au dessus\',\'varchar\',\'255\',\'0\',\'0\',\'0\','.$myarray_serialize')';
		
		//~ 'ALTER TABLE '.MAIN_DB_PREFIX.'propaldet_extrafields ADD titrealpiroc VARCHAR(255);',
		//~ 'ALTER TABLE '.MAIN_DB_PREFIX.'facturedet_extrafields ADD titrealpiroc VARCHAR(255);'
	...
	function remove($options='')
	{
		...
		//~ 'UPDATE '.MAIN_DB_PREFIX.'propal_extrafields  SET profilalpiroc=\'\';',
		//~ 'UPDATE '.MAIN_DB_PREFIX.'facture_extrafields  SET profilalpiroc=\'\';',
		...
		//~ 'ALTER TABLE '.MAIN_DB_PREFIX.'propaldet_extrafields DROP COLUMN titrealpiroc;',
		//~ 'ALTER TABLE '.MAIN_DB_PREFIX.'facturedet_extrafields DROP COLUMN titrealpiroc;',
